...
QT_MOC_LITERAL(1, 8, 14), // "salude_cliente"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 6) // "enviar"

    },
    "Cliente\0salude_cliente\0\0enviar"
};
...
void Cliente::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->salude_cliente(); break;
        case 1: _t->enviar(); break;
        default: ;
        }
        ...
        {
            typedef void (Cliente::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Cliente::salude_cliente)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Cliente::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Cliente.data,
